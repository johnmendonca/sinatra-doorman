...
Gem::Specification.new do |s|
  ...
  s.files = ["MIT-LICENSE", "Rakefile", "config.ru", "README.rdoc", "views/signup.haml", "views/reset.haml", "views/forgot.haml", "views/login.haml", "lib/rack", "lib/rack/contrib", "lib/rack/contrib/cookies.rb", "lib/doorman.rb", "lib/doorman", "lib/doorman/messages.rb", "lib/doorman/user.rb", "lib/doorman/base.rb", "lib/doorman/middleware.rb"]
